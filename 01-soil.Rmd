...
Acid sulphate soils occur on marine floodplains in temperate and tropical climates. When these floodplains are drained, pyrite in the soil is oxidised and high levels of acidity produced.

FeS~2~ + 15/4 O~2~ + 7/2 H~2~O $\rightarrow$ Fe(OH)~3~ + 2H~2~SO~4~

It's the sulphur that's oxidised here.
...
If these polymeric species are are arranged around the edge of the interlayer space, they can block other ions reaching exchange sites further into the interlayer space. 
...
[equivalents anions absorbed] - [equivalents cations absorbed] = [equivalents hydroxide and hydrogen carbonate released]
...
Look at Essington, s. 10.4 (liming etc.)
