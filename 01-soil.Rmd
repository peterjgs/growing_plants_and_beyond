...
- However, water percolating through the soil will mobilise and leach out the displaced base cations and soluble silica rather than adsorbed Al species and, as a result, acid neutralisation capacity of the soil will decrease and soil acidity will increase.

- An exchange process similar to that on the mineral exchange complex occurs at organic functional groups. Al bound to these groups cannot be easily displaced by base cations, which are then mobilised and leached out. Exchange at organic functional groups can release protons or base cations. Examples:

|        R---COOH^0^ + Al(OH)~2~^+^ $\rightarrow$ R---COO^-^---Al(OH)~2~^+^ + H^+^

or

|        R---[COO]~2~^2-^---Ca^2+^ + 2Al(OH)~2~^+^ $\rightarrow$ 2R---COOAl(OH)~2~^0^ + Ca^2+^
...
Generally, primary mineral weathering consumes protons (for example, hydrolysis); secondary mineral precipitation produces protons^[Essington, p. 480]. Examples:

- primary mineral weathering - dissolution of K-feldspar - protons consumed

|        KAlSi~3~O~8~(s) + 4H~2~O(l) + 4H^+^(aq) $\rightarrow$ Al^3+^(aq) + K^+^(aq) + 3H~4~SiO~4~^0^(aq)

- secondary mineral precipitation - metal hydrous oxide, gibbsite - protons produced

|        Al^3+^(aq) + 3H~2~O(l)  $\rightarrow$ Al(OH)~3~(s) + 3H^+^(aq)
...
Most oxidation reactions produce protons. Most reduction reactions consume protons.^[Essington, p. 482]
...
While human activities can increase soil acidity, soil acidification is a natural part of weathering and other natural processes.
...
Soil acidity affects:^[Sparks et al. 2024, ch. 9]
