...
- fungi don't really care about pH, as long as it's not extreme - they're pretty happy in the range, 4 < pH < 9
  
In most soils, soil acidity is related to H and Al. The latter is more important except when pH < 4.

As pH drops below about 5, Al, Fe and Mn - and other transition metals metals - become more soluble and can be toxic to plants. As pH increases, they become less soluble, start to precipitate and so become unavailable to plants.
...
```{r echo = F, out.width = '70%', fig.align = 'center', fig.cap = 'Sparks, p. 271.'}
...
```{r echo = F, out.width = '70%', fig.align = 'center', fig.cap = 'Sparks, Fig. 9.2, p. 272. Note: This diagram differs slightly in different books depending on how it was derived.'}
...
- the relative concentrations of the various Al ions depend on the pH of the soil solution:
  ...
  - in slightly acidic to highly acidic conditions, Al(OH)~2~^+^ and Al^3+^ predominate
  - when pH < 5, roughly, Al^3+^ predominates
  - when 5 < pH < 6.5, roughly, Al(OH)~2~^+^ predominates
  - when 5 < pH < 7.5, some Al will precipitate as Al(OH)~3~
