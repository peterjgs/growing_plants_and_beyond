...
At low pH, Al, Fe and Mn - and other transition metals metals - become more soluble and can be toxic to plants. As pH increases, they become less soluble and start to precipitate.
...
If the base cations are not leached, the acid neutralisation capacity of the soil is increased. However, water percolating through the soil will mobilise the displaced base cations rather than adsorbed Al species, acid neutralisation capacity of the soil will decrease and soil acidity will increase.
...
Exchangeable acidity is the amount of total CEC due to H^+^, which contributes the smaller component, and Al^3+^, the larger component. 
...
The proportion of exchangeable acidity out of total acidity in the minerals below decreases in this order:
