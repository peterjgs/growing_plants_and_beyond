...
### Overview and story - Essington

Material below is from Essington, sect. 10.1 and 10.2

Proton activity controls many chemical reactions, so pH is a "master" variable.
...
- during weathering, carbonic acid and organic acids are involved in the hydrolysis of soil minerals;
- in areas where rainfall exceeds evapotranspiration, base cations (Ca^2+^, Mg^2+^, K^+^, Na^+^) and silica become soluble and are leached from the soil
- other products of weathering, such as Al^3+^ and Fe^3+^, hydrolyse and release protons in the hydrolysis reactions, as well as accessory minerals (e.g. gibbsite (Al(OH)~3~) and goethite ($\alpha$-FeOOH))
  ...
  - the hydrolysis products of Fe^3+^ are Fe(OH)~2~^+^ (pH < 7.4), Fe(OH)~3~ (7.4 < pH < 8.5) and Fe(OH)~4~^-^ (pH > 8.5) (See Lindsay & Schwab 1982 - paper in Soil folder)^[Lindsay & Schwab, 1982, The chemistry of iron, https://doi.org/10.1080/01904168209363012]

There are three important processes that increase soil acidity:

- the hydrolysis reactions just described
- the removal of base cations from exchange sites by Al^3+^, AlOH^2+^ and Al(OH)~2~^+^ 
- the subsequent leaching of the basic cations, which do not hydrolyze to produce protons

However, the *fundamental cause of soil acidity* is Al species, which are labile (i.e. reactive, unstable) and can undergo hydrolysis and so produce protons, occupying exchange sites


Physical processes affect soil acidity:

- the processes that transport acidic and alkaline substances into, out of and throughout the soil profile
- substances that cause acidity enter the soil via precipitation (rain or snow) - such substances include carbonic acid and (hydrated) protons from industrial emissions (e.g. sulphuric acid from SO~2~ produced by coal-burning electric power stations)
- precipitation also supplies the water that leaches base cations through the soil profile
- various dry particles fall onto the soil surface (e.g. N and P fertilisers)
...
```{r echo = F, out.width = '70%', fig.align = 'center', fig.cap = 'Sparks 2003, p. 271.'}
...
If the base cations are not leached, the acid neutralisation capacity of the soil is increased. However, water percolating through the soil will mobilise the displaced base cations rather than adsorbed Al species and, as a result, acid neutralisation capacity of the soil will decrease and soil acidity will increase.
...
The amount of exchangeable acidity depends on the soil type, and so the amount of CEC due to exchangeable bases (i.e. Ca^2+^, Mg^2+^, K^+^ and Na^+^), which varies with soil type.

For the minerals below, the proportion of exchangeable acidity out of total acidity decreases in this order:
...
### Soil acidity - more of a storyline

Summary points below from Charman and Murphy, pp. 224ff

Natural factors affecting soil acidity:

- weathering of parent material
  - nature of parent material
  - climate - rainfall, temperature
- age of soil - younger soils have had less time to develop acidity
- season - soil pH fluctuates throughout the seasons

Factors influencing soil acidity due to human activities:

- agriculturally induced factors
  - applying fertilisers, especially ammonium fertilisers
  - allowing nitrate to leach from the soil
  - applying organic matter or allowing it to build up in the soil
  - removing produce
  - liming
...
**Following on from Charman and Murphy's points....**

**See also White pp. 50, sect. 7.2, p. 133, p. 234, p. 172 (leaching)**
