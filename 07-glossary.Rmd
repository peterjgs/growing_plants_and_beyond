...
- Wood is secondary xylem tissue (RAV, pp. 532 & 538).
...
- Softwoods are conifers.

**sapwood**

- Wood that still conducts water is sapwood. It usually has a lighter colour than heartwood.

**heartwood**

- Wood that no longer conducts water is heartwood and is darker than sapwood.

<br>

**monocarpic**  Flowering and bearing fruit only once and then dying
...
**degrees of hairiness** (from PlantNet)

- pubescent: fairly densely covered in short, weak, soft hairs

- tomentose: covered in dense intertwined hairs

<br>

**leaf shape**

- sinuate: strongly wavy margin with shallowly rounded divisions within the same plane of the leaf blade

- undulate: margin has wavy margin that occur above and below the plane of the leaf

(https://plantnet.rbgsyd.nsw.gov.au/cgi-bin/NSWfl.pl?page=nswfl&glossary=yes&term=undulate&ill=Fig.+8+J)
...
**labile** Labile refers to compounds that are easily transformed, particularly by biological activity. For example, labile phosphate is that proportion soil phosphate that can be easily converted into plant-available - or soluble - phosphate. The labile pool of a nutrient is the ions of that nutrient which are held on the exchange complex in the solid phase of the soil and which can replace the same ions in the soil solution, as those soluble ions are lost (e.g. by plant uptake, leaching).
